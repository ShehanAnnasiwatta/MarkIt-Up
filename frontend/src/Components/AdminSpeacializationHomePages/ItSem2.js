...
function ItSem2() {
    ...
    const Datagetting=async()=>{
        axios.get('http://localhost:3005/AddAssi/GetItSem2').then((res)=>{
...
<Stack sx={{width:100,marginLeft:2}}>
                                     <Button variant="outlined" startIcon={<DeleteIcon />} onClick={() => DeleteItems(data._id)}>Delete</Button>
                                        ...
                                        <a href={`/ItSem2Add/${i}`}><Button  startIcon={<Add />} color="primary"> Add Assignment</Button></a>
